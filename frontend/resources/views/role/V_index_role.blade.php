...
@section('content')
    <div class="container mt-3 mb-3">
        <div class="mb-3 d-flex align-items-center justify-content-between">
            <h3>Daftar Peran</h3>
            <div>
                <a href="{{ url('/dashboard') }}">Dashboard</a> / <span>Daftar Peran</span>
            </div>
        </div>
        <div class="card">
            <div class="card-header">
                <a href="{{ route('roles.create') }}" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Tambah</a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($roles as $item)
                            <tr class="text-nowrap">
                                <td style="width: 1%">
                                    <a href="{{ route('roles.edit', $item->uuid) }}" class="btn btn-warning btn-sm" title="Ubah"><i class="bi bi-pencil"></i></a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('roles.destroy', $item->uuid) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
